...
package com.example.walkarround.base.supertoasts;
...
import com.example.walkarround.base.supertoasts.utils.AccessibilityUtils;
import com.example.walkarround.base.supertoasts.utils.AnimationUtils;
import com.example.walkarround.base.supertoasts.utils.BackgroundUtils;
...
//        if (this.mStyle.frame == Style.FRAME_CUSTOM) {
//            this.mTextView.setLayerType(LAYER_TYPE_SOFTWARE, null);
//            this.mTextView.setShadowLayer(10,100,100, BackgroundUtils.getCustomShadowColor());
//        }
        ...
        if (this.mStyle.messageIconResource > 0) {
            ...
            this.mTextView.setCompoundDrawablePadding(CommonUtils.dip2px(WalkArroundApp.getInstance().getApplicationContext(),6));
        }
