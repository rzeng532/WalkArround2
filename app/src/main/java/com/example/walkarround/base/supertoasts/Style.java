...
import com.example.walkarround.base.supertoasts.utils.PaletteUtils;

import java.lang.annotation.Retention;
import java.lang.annotation.RetentionPolicy;

/**
 * This class will store references to the various attributes of a
 */
...
public class Style implements Parcelable {
    ...
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({FRAME_STANDARD, FRAME_KITKAT, FRAME_LOLLIPOP, FRAME_CUSTOM})
...
//            Gravity.RIGHT, Gravity.START, Gravity.TOP})
    ...
    public static final int FRAME_CUSTOM = 4;
