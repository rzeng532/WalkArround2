package com.example.walkarround.base.view.gifview;
...
/**
 * GifView
 * 可以显示一个gif动画，其使用方法和android的其它view（如imageview)一样。
...
public class GifView extends View implements GifAction {
    ...
    private Logger logger = Logger.getLogger(GifView.class.getSimpleName());
    /**
     * gif解码器
     */
                ...
                switch (animationType) {
                    ...
                    case COVER:
                        if (frameIndex == 1) {
                            ...
                            if (gifDecoder != null && gifDecoder.getFrameCount() > 1) {
                                if (drawThread == null) {
                                    isRun = true;
                                    drawThread = new DrawThread();
                                    drawThread.start();
    ...
    private void reDraw() {
        if (redrawHandler != null) {
            Message msg = redrawHandler.obtainMessage(MSG_INVALIDATE);
    ...
    private class DrawThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                logger.e("DrawThread Exception:" + e.getMessage());
                drawThread = null;
            }
        }
    }
