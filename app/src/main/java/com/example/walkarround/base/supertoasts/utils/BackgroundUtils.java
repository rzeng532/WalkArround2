...
package com.example.walkarround.base.supertoasts.utils;
...
import com.example.walkarround.base.supertoasts.Style;
...
public class BackgroundUtils {
    ...
    public static Drawable getBackground(Style style, int color) {
        ...
        if (style.frame > 0) {
            switch (style.frame) {
                ...
                case Style.FRAME_CUSTOM: return BackgroundUtils.getCustomBackground(color);
                default:
                    break;
            }
        }
     ...
     * Private method.
     *
     * Returns a {@link Drawable} with
     * rounded corners.
     *
     * @param color The desired color of the GradientDrawable
     * @return A {@link Drawable}
     */
    private static Drawable getCustomBackground(int color) {
        return WalkArroundApp.getInstance().getResources().getDrawable(R.drawable.common_toast_background);
    }
     ...
     * @return
     */
    public static int getCustomShadowColor() {
        return WalkArroundApp.getInstance().getResources().getColor(R.color.cor1);
    }
}