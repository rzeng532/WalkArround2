package com.awalk.walkarround.radar;
...
import static com.awalk.walkarround.R.*;
    ...
    private void init(AttributeSet attrs, Context context)
    {
        if (attrs != null)
        {
            TypedArray ta = context.obtainStyledAttributes(attrs,
                styleable.RadarScanView);
            circleColor = ta.getColor(styleable.RadarScanView_circleColor, circleColor);
            radarColor = ta.getColor(styleable.RadarScanView_radarColor, radarColor);
            tailColor = ta.getColor(styleable.RadarScanView_tailColor, tailColor);
            ta.recycle();
        }
