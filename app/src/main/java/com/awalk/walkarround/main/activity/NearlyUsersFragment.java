...
import com.awalk.walkarround.flingswipe.SwipeFlingAdapterView;
import com.awalk.walkarround.main.adapter.NearlyUserListAdapter;
import com.awalk.walkarround.main.model.ContactInfo;
import com.awalk.walkarround.main.parser.WalkArroundJsonResultParser;
import com.awalk.walkarround.main.task.LikeSomeOneTask;
        ...
        mUserFrame.setFlingListener(new SwipeFlingAdapterView.onFlingListener() {
            ...
            public void onRightCardExit(Object dataObject) {
                ...
                if(AssistantHelper.isThereGuideStep()
                    ...
                    mIvUnreadIcon.setVisibility(View.VISIBLE);
                    WalkArroundMsgManager.getInstance(getActivity().getApplicationContext())
                            .updateConversationStatus(recipientInfo.getThreadId(), MessageUtil.WalkArroundState.STATE_IM);
