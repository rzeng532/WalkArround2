 ...
 */
public class EndSpeedDateTask extends HttpTaskPost {
    public EndSpeedDateTask(Context context, onResultListener listener, String requestCode, String urlString, String contentStr, Map<String, String> header) {
