...
import com.awalk.walkarround.message.task.EndSpeedDateTask;
import com.awalk.walkarround.message.task.EvaluateFriendTask;
    ...
    private void initView() {
        ...
        if (mFriend != null) {
            ...
            mPvPortrait.setBaseData(friendName, mFriend.getPortrait().getUrl(), null,
                    mFriend.getPortrait().getDefaultId());
        }
    }
