 ...
 */
public class QueryDynDataTask extends HttpTaskPost {
    public QueryDynDataTask(Context context, onResultListener listener, String requestCode, String urlString, String contentStr, Map<String, String> header) {
