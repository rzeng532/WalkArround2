...
//    private boolean mBroadcasting;
    ...
    private void initView(Context context) {
        ...
        // get Bitmap
        mBottom = BitmapFactory.decodeResource(resources, R.drawable.public_switch_bg);
//        mBtnPressed = BitmapFactory.decodeResource(resources, R.drawable.public_switch_off);
        mBtnNormal = BitmapFactory.decodeResource(resources, R.drawable.public_switch_off);
        mFrame = BitmapFactory.decodeResource(resources, R.drawable.public_switch_shadow);
        mMask = BitmapFactory.decodeResource(resources, R.drawable.public_switch_mask);
        mBtnFinish = BitmapFactory.decodeResource(resources, R.drawable.public_switch_on);
