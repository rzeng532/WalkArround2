...
public class UriImage {
    ...
    public byte[] getResizedImageData(int widthLimit, int heightLimit, int byteLimit) {
        ...
        /*
         * while ((outWidth / scaleFactor > widthLimit) || (outHeight / scaleFactor > heightLimit)) { scaleFactor *= 2;
         * }
         */

        /*
         * Log.d("XXX", "getResizedImageData: wlimit=" + widthLimit + ", hlimit=" + heightLimit + ", sizeLimit=" +
         * byteLimit + ", mWidth=" + mWidth + ", mHeight=" + mHeight + ", initialScaleFactor=" + scaleFactor);
         */
        ...
        try {
            ...
            do {
                ...
                // Log.v(TAG, "attempt=" + attempts + " size=" + (os == null ? 0 : os.size()) + " width=" + outWidth /
                // scaleFactor + " height=" + outHeight / scaleFactor
