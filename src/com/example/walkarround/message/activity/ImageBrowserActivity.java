...
public class ImageBrowserActivity extends Activity implements OnClickListener {
    ...
    private void initView() {
        ...
        if (!mIsFullSizeOption) {
            mBtnSend.setText(getResources().getString(R.string.msg_select_pics_finish_multi, sendingCount, mMaxNum));
        } else {
            mBtnSend.setText(getResources().getString(R.string.msg_select_pics_send_multi, sendingCount, mMaxNum));
        }
                ...
                switch (mViewType) {
                    ...
                    case _TYPE_FROM_PIC_SELECT:
                        ...
                        if (mOriginCheckedMap.contains(filePath)) {
                            ...
                            mPicFullSizeCb.setText(getString(R.string.pic_full_size) + getFileLength(filePath));
                        } else {
                            mPicFullSizeCb.setChecked(false);
                            mPicFullSizeCb.setText(R.string.pic_full_size);
                        }
    ...
    public void onClick(View v) {
        ...
        case R.id.ok_btn:
            ...
            case _TYPE_FROM_PIC_SELECT:
                if (mChoseImageList.size() > 0) {
                    ...
                    Toast.makeText(ImageBrowserActivity.this, R.string.msg_select_pic, Toast.LENGTH_SHORT).show();
                }
                break;
            default:
                break;
            ...
            switch (mViewType) {
                ...
                case _TYPE_FROM_PIC_SELECT:
                    ...
                    if (mPicFullSizeCb.isChecked()) {
                        mPicFullSizeCb.setText(getString(R.string.pic_full_size) + getFileLength(imagePath));
        ...
        case R.id.pic_select_check:
            if (!mPicSelectCb.isChecked()) {
                ...
                if (!mIsFullSizeOption) {
                    mBtnSend.setText(getResources().getString(R.string.msg_select_pics_finish_multi, mChoseImageList.size(), mMaxNum));
                } else {
                    mBtnSend.setText(getResources().getString(R.string.msg_select_pics_send_multi, mChoseImageList.size(), mMaxNum));
                }
            } else {
